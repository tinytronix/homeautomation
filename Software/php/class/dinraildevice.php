<?php
  ...
  define('DEVICE_SCHALTMODUL_A_ID01',	intval(DEVICE_CLASS_SCHALTMODUL | DEVICE_TYPE_A | 0x01));	//Schaltmodul (I2C Adresse 0x20: JP1=0, JP2=0, JP3=0)
  define('DEVICE_SCHALTMODUL_A_ID02',	intval(DEVICE_CLASS_SCHALTMODUL | DEVICE_TYPE_A | 0x02));	//Schaltmodul (I2C Adresse 0x20: JP1=1, JP2=0, JP3=0)
  define('DEVICE_SCHALTMODUL_A_ID03',	intval(DEVICE_CLASS_SCHALTMODUL | DEVICE_TYPE_A | 0x03));	//Schaltmodul (I2C Adresse 0x20: JP1=0, JP2=2, JP3=0)
